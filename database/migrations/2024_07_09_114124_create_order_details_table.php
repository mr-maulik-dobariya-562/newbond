...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('order_details', function (Blueprint $table) {
            ...
            $table->foreignId('print_type_other_id')->nullable()->references('id')->on('print_type_extras')->onDelete('cascade')->onUpdate('cascade');
            $table->string('qty',15,2)->default('0');
            $table->string('rate',15,2)->default('0');
            $table->string('dispatch_qty',15,2)->default('0');
            $table->string('cancel_qty',15,2)->default('0');
