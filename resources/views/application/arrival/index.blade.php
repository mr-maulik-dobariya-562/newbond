                        ...
                        <table class="table table-loader table-vcenter table-hover card-table" id="country-table">
                            <thead>
                                <tr>
                                    ...
                                    <th data-name="sequence">Sequence</th>
...
<form id="country-form" action="{{ route('application.arrival.store') }}" enctype="multipart/form-data" method="POST">
    @csrf
    <div class="modal modal-blur fade" id="country-modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"> <span class="title">Add</span> Arrival</h5>
                ...
                <div class="modal-body">
                    <div class="row mb-1 align-items-end">
                        ...
                        <div class="col-md-6">
                            ...
                            <input class="form-control" type="text" name="sequence" placeholder="Enter Order" />
                        </div>
                        ...
                        <div class="col-md-6 pt-2">
                            <label class="form-label">New Arrival Image</label>
...
<script>
    $(document).ready(function() {
        ...
        var table = window.table(
            "#country-table",
            "{{ route('application.arrival.getList') }}",
        );
        window.edit = false;
        ...
        $(".add-new-btn").click(function() {
            ...
            countryModal.parents("form").attr("action", '{{ route("application.arrival.store") }}');
            window.edit = false;
        });
        $('#status').select2({
        ...
        $(document).on('click', '.edit-btn', function() {
            ...
            const edit_url = "{{ route('application.arrival.update', ':id') }}";
            ...
            countryModal.find("input[name='sequence']").val(sequence);
