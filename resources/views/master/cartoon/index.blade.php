...
@section("content")
    ...
    <form id="modal-form" action="{{ route('master.cartoon.store') }}" enctype="multipart/form-data" method="POST">
        @csrf
        <div class="modal modal-blur fade" id="modal" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"> <span class="title">Add</span> Cartoon</h5>
                    ...
                    <div class="modal-body">
                        <div class="row mb-3 align-items-end">
                            <div class="col-md-12 mb-4">
                                ...
                                <input class="form-control" type="text" name="size" placeholder="Enter Cartoon Size" />
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = window.table(
                "#datatable",
                "{{ route('master.cartoon.getList') }}",
            );
            window.edit = false;

            $(".add-new-btn").click(function() {
                modal.find(".title").text("Add");
                modal.parents("form").attr("action", '{{ route("master.cartoon.store") }}');
                window.edit = false;
            });
            ...
            $(document).on('click', '.edit-btn', function() {
                ...
                const edit_url = "{{ route('master.cartoon.update', ':id') }}";
