    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="card-title">Party Group</h3>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
...
<form id="modal-form" action="{{ route('master.party-group.store') }}" enctype="multipart/form-data" method="POST">
    @csrf
    <div class="modal modal-blur fade" id="modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"> <span class="title">Add</span> Party Group</h5>
                ...
                <div class="modal-body">
                    <div class="row mb-3 align-items-end">
                        <div class="col">
                            ...
                            <input class="form-control" type="text" name="name" placeholder="Enter Party Group Name" />
                        </div>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        var table = window.table(
            "#datatable",
            "{{ route('master.party-group.getList') }}",
        );
        window.edit = false;

        $(".add-new-btn").click(function() {
            modal.find(".title").text("Add");
            modal.parents("form").attr("action", '{{ route("master.party-group.store") }}');
            window.edit = false;
        });
        ...
        $(document).on('click', '.edit-btn', function() {
            ...
            const edit_url = "{{ route('master.party-group.update', ':id') }}";
