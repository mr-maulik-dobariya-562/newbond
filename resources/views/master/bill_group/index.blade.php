...
<div class="page-header d-print-none">
    <div class="row g-2 align-items-center">
        ...
        <div class="col-auto ms-auto d-print-none">
            <div class="btn-list">
                <a class="btn btn-primary d-none d-sm-inline-block add-new-btn" data-bs-toggle="modal" data-bs-target="#group-modal" href="#">
                ...
                <a class="btn btn-primary d-sm-none btn-icon add-new-btn" data-bs-toggle="modal" data-bs-target="#group-modal" href="#" aria-label="Create new report">
                    <svg class="icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        <path d="M12 5l0 14" />
                        <path d="M5 12l14 0" />
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="card-title">Bill Group</h3>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-loader table-vcenter card-table" id="group-table">
                            <thead>
                                <tr>
...
<form id="modal-form" action="{{ route('master.bill-group.store') }}" method="POST">
    @csrf
    <div class="modal modal-blur fade" id="group-modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"> <span class="title">Add</span> Bill Group</h5>
...
<script>
    $(document).ready(function() {
        ...
        var table = window.table(
            "#group-table",
            "{{ route('master.bill-group.getList') }}",
        );
        ...
        $(".add-new-btn").click(function() {
            ...
            modal.parents("form").attr("action", '{{ route("master.bill-group.store") }}');
            window.edit = false;
        });
        ...
        $(document).on('click', '.edit-btn', function() {
            ...
            const edit_url = "{{ route('master.bill-group.update', ':id') }}";
