        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-header">
                    <h3 class="card-title">Print Type</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <table class="table table-loader table-vcenter table-hover card-table" id="country-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-name="short_name">Short Name</th>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"> <span class="title">Add</span> Print Type</h5>
                    ...
                    <div class="modal-body">
                        <div class="row mb-3 align-items-end">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control" type="text" name="short_name" placeholder="Enter Short Name" />
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            var table = window.table(
                "#country-table",
                "{{ route('master.print-type.getList') }}",
            );
            window.edit = false;

            $(".add-new-btn").click(function () {
                countryModal.find(".title").text("Add");
                countryModal.parents("form").attr("action", '{{ route("master.print-type.store") }}');
                window.edit = false;
            });
            ...
            $(document).on('click', '.edit-btn', function () {
                ...
                const short_name = $(this).data("short_name");
                const edit_url = "{{ route('master.print-type.update', ':id') }}";
                ...
                countryModal.find("input[name='short_name']").val(short_name);
