...
<form id="modal-form" action="{{ route('master.bank.store') }}" method="POST">
    @csrf
                ...
                <div class="modal-body">
                    <div class="row mb-3 align-items-end">
                        <div class="col-md-12">
                            ...
                            <input class="form-control" type="text" name="name" placeholder="Enter Bank Name" />
                        </div>
                    </div>
                </div>
