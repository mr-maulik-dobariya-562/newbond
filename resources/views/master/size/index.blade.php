...
<form id="modal-form" action="{{ route('master.size.store') }}" enctype="multipart/form-data" method="POST">
    @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-3 align-items-end">
                        <div class="col">
                            ...
                            <input class="form-control" type="text" name="symbol" placeholder="Enter Symbol" />
                        </div>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        var table = window.table(
            "#datatable",
            "{{ route('master.size.getList') }}",
        );
        window.edit = false;

        $(".add-new-btn").click(function() {
            modal.find(".title").text("Add");
            modal.parents("form").attr("action", '{{ route("master.size.store") }}');
            window.edit = false;
        });
        ...
        $(document).on('click', '.edit-btn', function() {
            ...
            const edit_url = "{{ route('master.size.update', ':id') }}";
