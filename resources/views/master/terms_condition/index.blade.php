...
<form id="modal-form" action="{{ route('master.terms-condition.store') }}" enctype="multipart/form-data" method="POST">
    @csrf
    <div class="modal modal-blur fade" id="modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"> <span class="title">Add</span> Terms & Conditions</h5>
                ...
                <div class="modal-body">
                    <div class="row mb-3 align-items-end">
                        <div class="col">
                            ...
                            <textarea class="form-control" name="name" placeholder="Enter Terms & Conditions"></textarea>
                        </div>
                    </div>
                    <div class="row mb-3 align-items-end">
                        <div class="col">
...
<script>
    $(document).ready(function() {
        ...
        var table = window.table(
            "#datatable",
            "{{ route('master.terms-condition.getList') }}",
        );
        window.edit = false;
        ...
        $(".add-new-btn").click(function() {
            ...
            modal.parents("form").attr("action", '{{ route("master.terms-condition.store") }}');
            window.edit = false;
        });
        ...
        $(document).on('click', '.edit-btn', function() {
            ...
            const edit_url = "{{ route('master.terms-condition.update', ':id') }}";
