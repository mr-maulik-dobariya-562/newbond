...
<div class="page-header d-print-none">
    <div class="row g-2 align-items-center">
        ...
        <div class="col-auto ms-auto d-print-none">
            <div class="btn-list">
                <a class="btn btn-primary d-none d-sm-inline-block add-new-btn" data-bs-toggle="modal" data-bs-target="#modal" href="#">
                ...
                <a class="btn btn-primary d-sm-none btn-icon add-new-btn" data-bs-toggle="modal" data-bs-target="#modal" href="#" aria-label="Create new report">
                    <svg class="icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        <path d="M12 5l0 14" />
                        <path d="M5 12l14 0" />
                        ...
                        <table class="table table-loader table-vcenter table-hover card-table" id="datatable">
                            <thead>
                                <tr>
                                    ...
                                    <th data-name="party_type">Party Type</th>
                                    <th data-name="value_type">Value Type</th>
...
<form id="modal-form" action="{{ route('master.offers.store') }}" enctype="multipart/form-data" method="POST">
    @csrf
    <div class="modal modal-blur fade" id="modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"> <span class="title">Add</span> Offers</h5>
                ...
                <div class="modal-body">
                    <div class="row mb-3 align-items-end">
                        <div class="col">
                            ...
                            <textarea class="form-control" name="name" placeholder="Enter Offers"></textarea>
                        </div>
                    </div>
                    <div class="row mb-3 align-items-end">
                        <div class="col">
                    ...
                    <div class="row mb-3 align-items-end">
                        <div class="col">
                            ...
                            <select class="form-select select2" name="value_type">
...
<script>
    $(document).ready(function() {
        ...
        var table = window.table(
            "#datatable",
            "{{ route('master.offers.getList') }}",
        );
        window.edit = false;

        $(".add-new-btn").click(function() {
            modal.find(".title").text("Add");
            modal.find(".modal-body").find("input, select, textarea").val("");
            modal.parents("form").attr("action", '{{ route("master.offers.store") }}');
            window.edit = false;
        });
        ...
        $(document).on('click', '.edit-btn', function() {
            ...
            const party_type_id = $(this).data("party_type_id");
            const edit_url = "{{ route('master.offers.update', ':id') }}";
            modal.parents("form").attr("action", edit_url.replace(":id", id));
            modal.find(".title").text("Edit");
            modal.find("textarea[name='name']").text(name);
            modal.find("select[name='party_type_id']").val(party_type_id).trigger("change");
            modal.find("select[name='value_type']").val($(this).data("value_type")).trigger("change");
