...
<form id="modal-form" action="{{ route('manufacture-master.machine-type.store') }}" method="POST">
    @csrf
    <div class="modal modal-blur fade" id="city-modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"> <span class="title">Add</span> Machine Type</h5>
...
<script>
    $(document).ready(function() {
        ...
        var table = window.table(
            "#bank-table",
            "{{ route('manufacture-master.machine-type.getList') }}",
        );
        ...
        $(".add-new-btn").click(function() {
            ...
            modal.parents("form").attr("action", '{{ route("manufacture-master.machine-type.store") }}');
            window.edit = false;
        });
        ...
        $(document).on('click', '.edit-btn', function() {
            ...
            const edit_url = "{{ route('manufacture-master.machine-type.update', ':id') }}";
