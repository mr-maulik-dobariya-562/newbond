    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-loader table-vcenter card-table" id="location-table">
                            <thead>
                                <tr>
...
<form id="modal-form" action="{{ route('manufacture-master.location.store') }}" method="POST">
    @csrf
    <div class="modal modal-blur fade" id="city-modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"> <span class="title">Add</span> Location</h5>
                ...
                <div class="modal-body">
                    <div class="row mb-3 align-items-end">
                        <div class="col-md-12">
                            ...
                            <input class="form-control" type="text" name="name" placeholder="Enter Location Name" />
                        </div>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        var table = window.table(
            "#location-table",
            "{{ route('manufacture-master.location.getList') }}",
        );
        ...
        $(".add-new-btn").click(function() {
            ...
            modal.parents("form").attr("action", '{{ route("manufacture-master.location.store") }}');
            window.edit = false;
        });
        ...
        $(document).on('click', '.edit-btn', function() {
            ...
            const edit_url = "{{ route('manufacture-master.location.update', ':id') }}";
