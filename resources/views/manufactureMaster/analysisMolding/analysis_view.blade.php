<div class="row">
    ...
    <div style="width: 70%; margin: 0; float: left;">
        <div class="page-header" style="text-align: center;">
            <h3>Total Production Weight (Kgs) by Machine Number</h3>
        </div>
        <canvas id="Machine"></canvas>
    </div>
    <div style="width: 30%; margin: 0; float: left;">
        <div class="page-header" style="text-align: center;">
            <h3>Location Wise Runner Waste (%)</h3>
        </div>
        <canvas id="locationRunner"></canvas>
    </div>
    <div style="width: 100%; margin: 0; float: left;">
        <div class="page-header" style="text-align: center;">
            <h3>Production Weight & Production Pieces Quantity by Day of Month</h3>
        </div>
