    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="card-title">Row Material</h3>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
...
<form id="modal-form" action="{{ route('manufacture-master.row-material.store') }}" method="POST">
    @csrf
    <div class="modal modal-blur fade" id="city-modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"> <span class="title">Add</span> Row Material</h5>
...
<script>
    $(document).ready(function() {
        ...
        var table = window.table(
            "#bank-table",
            "{{ route('manufacture-master.row-material.getList') }}",
        );
        ...
        $(".add-new-btn").click(function() {
            ...
            modal.parents("form").attr("action", '{{ route("manufacture-master.row-material.store") }}');
            window.edit = false;
        });
        ...
        $(document).on('click', '.edit-btn', function() {
            ...
            const edit_url = "{{ route('manufacture-master.row-material.update', ':id') }}";
