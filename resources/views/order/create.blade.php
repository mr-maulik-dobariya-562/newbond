                    ...
                    <div class="card-body">
                        <div class="row pb-2">
                            <div class="col-md-4">
                                ...
                                <select class="form-select ajax-customer" id="customer" name="customer_id" required>
                            ...
                            <div class="col-md-2 pt-2 d-none">
                            ...
                            <div class="pt-4">
                                <div class="col-md-12">
                                        ...
                                        <table
                                            ...
                                            <tbody class="append-here">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 2px !important">
                                                        @if(isset($image[$key]) && $image[$key])
                                                            <img src='{{ $image[$key] }}' class="img-url" style='width:60px; height:50px;' />
                                                            <span class="not-found-image">Image Not Found</span>
                                                        @endif
                                                    </td>
                                                    <td style="padding: 2px !important">
                                                        <input
                                                ...
                                                <tr class="mainRow">
                                                    ...
                                                    <td style="padding: 2px !important">
                                                        <img src='' class="img-url" style='width:60px; height:50px;' />
                                                        <span class="not-found-image">Image Not Found</span>
                                                    </td>
                                                    <td style="padding: 2px !important">
                                                        <input
                                            ...
                                            <tfoot>
                                                <tr style="font-weight: bolder;">
                                                    ...
                                                    <td>
                                                        {{-- Block Find : {{ old("block_find", $order?->block_find ?? "No")
                                                        }} --}}
                                                    </td>
                                                    <td colspan="8"></td>
                                                </tr>
                                    ...
                                    <div class="text-left pt-1">
                                        <button type="button" class="btn btn-success addButton"><i class="fas fa-plus"></i>
                                            &nbsp;Add</button>
                                    </div>
                                    ...
                                    <div class="row col-md-12">
                                        ...
                                        <div class="col-md-1 pb-1">
                                            <label class="form-label required" id="total_label">Total Amount :</label>
                                        ...
                                        <div class="row col-md-6 pb-1 d-none">
                                            ...
                                            <div class="col">
                                                <input class="form-control no-spinners d-none" min="0" step="any"
                                                    type="number" name="payment_amount" value='{{ old("payment_amount", $order?->payment_amount ?? "") }}'
                                        ...
                                        <div class="col-md-1 pb-1" style="    width: 90px;">
                                            ...
                                            <input class="form-control no-spinners" min="0" step="any" id="discount"
                                                type="number" name="discount" value='{{ old("discount", $order?->discount ?? "0") }}'
                                        ...
                                        <div class="col-md-1 pb-1">
                                            ...
                                            <input class="form-control no-spinners" min="0" step="any" id="discount_amount"
                                                type="number" name="discount_amount" value='{{ old("discount_amount", $order?->discount_amount ?? "0") }}'
                                                placeholder="Enter Discount" readonly />
                                        </div>
                                        ...
                                        <div class="col-md-1">
                                            ...
                                            <input class="form-control no-spinners" id="redeem_coin" min="0" step="any"
                                                type="number" name="redeem_coin" value='{{ old("redeem_coin", $order?->redeem_coin ?? "") }}'
                                                data-redeem-coin="{{ $order?->last_closing ?? '' }}" placeholder="Enter Coin" readonly />
                                        </div>
                                        ...
                                        <div class="row col-md-6 d-none">
                                            ...
                                            <div class="col" style="padding: 10px 11px;">
                                                <input class="form-check-input d-none" type="checkbox" name='is_verified' {{ old("is_verified", $order?->is_verified ?? "") == 1 ? "checked" : "" }} value='1' />
                                            </div>
                                        </div>
                                        <div class="col-md-1">
                                            <label class="form-label required" id="net_amount_label">Net Amount :</label>
                                            <input class="form-control no-spinners" id="net_amount" min="0" step="any"
                                                type="number" name="net_amount" value='{{ old("net_amount", $order?->net_amount ?? "") }}'
                                                placeholder="Enter Amount" readonly />
                                        </div>
                                        <div class="col-md-1">
                                            <label class="form-label">Cashback Coin</label>
                                            <input class="form-control no-spinners" id="last_closing" step="any"
                                                type="number" value='{{ $order?->last_closing ?? "" }}'
                                        ...
                                        <div class="col-md-1" style="display: none;">
                                            ...
                                            <input class="form-control no-spinners" id="cash_back_coin" min="0" step="any"
                                                type="number" name="cash_back_coin" value='{{ old("cash_back_coin", $order?->cash_back_coin ?? "") }}'
                                                placeholder="Enter Coin" readonly />
                                        </div>

                                        <div class="col-md-2 pt-2" style="margin-top: 1.5rem;">
                                            <button class="btn btn-primary ms-auto" type="submit" id="submitData">
                                                Submit <i class="fa-solid fa-spinner fa-spin ms-1 save-loader" style="display:none"></i>
                                            </button>
                                            <a class="btn btn-warning me-2" href="{{ route('order.index') }}">Back</a>
                                        </div>
                                        ...
                                        <div class="col-md-1 pt-2">
                                            ...
                                            <select class="form-select block @error('block_find') is-invalid @enderror"
                                                name="block_find">
                                                <option value="Yes" {{ old("block_find", $order?->block_find ?? "") == "Yes" ? "selected" : "" }}> Yes </option>
                                                <option value="No" {{ old("block_find", $order?->block_find ?? "") == "No" ? "selected" : "" }} {{ !isset($order->block_find) ? "selected" : "" }}> No </option>
                                            </select>
                                        </div>
                                                ...
                                                @foreach ($orderPayments as $payment)
                                                    <div class="row col-md-12 payment-row">
                                                        ...
                                                        <div class="col-md-5 pb-1">
                                                            ...
                                                            <input class="form-control" type="date" name="paymentDate[]" value='{{ $payment->date }}' placeholder="Enter Date" />
                                                        </div>
                                                        <div class="col-md-3 pb-1">
                                                            <label class="form-label required">Amount :</label>
                                                            <input class="form-control" name="paymentAmount[]" placeholder="Enter Amount" min="0" step="any" value='{{ $payment->amount }}' type="number">
                                                        </div>

                                                        <div class="col-md-2" style="margin-top: 1.9rem;">
                                                            <button type="button" class="btn btn-success form-control" id="addPayment"><i class="fas fa-plus"></i>Add</button>
                                                        </div>
                                                        <div class="col-md-2" style="margin-top: 1.9rem;">
                                                            <button type="button" class="btn btn-danger form-control removePayment"><i class="fas fa-trash"></i></button>
                                                        </div>
                                                    </div>
                                                @endforeach
                                            @else
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '.addButton', function () {
                ...
                if (lastQuantity > 0 && itemID != null) {
                    ...
                    sweetAlert("error", 'Item And Quantity Field Required.');
                }
            });
            ...
            if(window.edit){
                $('.img-url').show();
                $(".not-found-image").hide();
            } else {
                $('.img-url').hide();
                $(".not-found-image").show();
            }
                    ...
                    http.post(
                        ...
                        if (result) {
                            ...
                            if (result.image == null ||result.image == '') {
                                row.find('.img-url').attr('src', '').hide();
                                row.find('.not-found-image').show();
                            } else {
                                row.find('.img-url').attr('src', result.image).show();
                                row.find('.not-found-image').hide();
                            }
                        }
                    });
                } else {
            ...
            function comamanfinalamount() {
                ...
                if (netAmount > 0) {
                    redeemCoin = parseFloat($('#redeem_coin').data('redeem-coin') ?? 0) ?? 0;
                    var balance = 0;
                    var data = ($('#customer').select2('data')[0]);


                        balance = window.edit ? redeemCoin : data.balance;
